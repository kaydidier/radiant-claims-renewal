...
<script>
    // Set up the Claims Status Chart
    var ctx = document.getElementById("claimsStatusChart");
    var claimsStatusChart = new Chart(ctx, {
        type: 'doughnut',
        data: {
    ...
    // Set up the Renewals Status Chart
    var ctx = document.getElementById("renewalsStatusChart");
    var renewalsStatusChart = new Chart(ctx, {
        type: 'bar',
        data: {
            labels: ["Approved", "Rejected", "Pending"],
            datasets: [{
